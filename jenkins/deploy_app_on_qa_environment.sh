...
AWS_REGION=$AWS_REGION helm repo add stable-petclinic s3://petclinic-helm-charts-melis/stable/myapp/ || echo "repository name already exists"
...
sudo su kubectl create secret generic regcred -n petclinic-qa \
